...
import { Search, Plus, Home, List, Settings, ChevronRight, Camera, ImageIcon } from "lucide-react"
            ...
            <form onSubmit={handleAddItem} className="space-y-4 mt-4">
              ...
              <div className="space-y-2">
                ...
                <div className="flex justify-center items-center gap-4">
                  <Button type="button" onClick={() => pickImage("camera")} className="flex-1">
                    <Camera className="mr-2 h-4 w-4" />
                    カメラ
                  </Button>
                  <Button type="button" onClick={() => pickImage("gallery")} className="flex-1">
